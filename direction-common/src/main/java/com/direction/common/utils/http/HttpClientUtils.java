package com.direction.common.utils.http;
...
public class HttpClientUtils {
	 ...
	 * @return
	 */
	public static String ajaxKujialePostJson(String url, String jsonString, String charset) {
	 ...
	 * http的post请求，增加异步请求头参数，传递json格式参数
	 */
	public static byte[] postJson(String url, String jsonString, String charset) {

		HttpPost httpPost = new HttpPost(url);

		StringEntity stringEntity = new StringEntity(jsonString, charset);// 解决中文乱码问题
		httpPost.setEntity(stringEntity);
		httpPost.setHeader("Content-Type", "text/plain;charset=GBK");
		stringEntity.setContentEncoding(charset);
